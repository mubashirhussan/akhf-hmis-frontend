...
export const DELIVERED_PAYMENT_STATUS_META = {
...
export const DELIVERED_DELIVER_RELATION_OPTIONS = [
  { value: 'S/O', label: 'S/O' },
  { value: 'D/O', label: 'D/O' },
  { value: 'W/O', label: 'W/O' },
];

export function formatDeliveredBookingDate(requestedDate) {
...
export function getDeliveredReportLineItems(record) {
  ...
  return tests.map((test, index) => {
    ...
    const paymentMeta = DELIVERED_PAYMENT_STATUS_META[paymentStatus];
    ...
    return {
      ...
      bookingDate: formatDeliveredBookingDate(record?.requestedDate),
      paymentStatus,
...
export function createDeliveredDeliveryForm(record) {
