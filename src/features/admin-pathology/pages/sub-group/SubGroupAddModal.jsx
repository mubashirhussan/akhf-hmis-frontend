...
import {
  SUB_GROUP_FIELDS,
  SUB_GROUP_INITIAL_VALUES,
} from '@/features/admin-pathology/pages/sub-group/sub-group-fields';

export default function SubGroupAddModal({ open, onClose, form, onSave }) {
  ...
  return (
    ...
    >
      <Form
        ...
        requiredMark
        preserve={false}
        initialValues={SUB_GROUP_INITIAL_VALUES}
      >
