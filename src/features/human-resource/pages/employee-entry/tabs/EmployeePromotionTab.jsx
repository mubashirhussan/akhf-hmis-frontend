...
import {
  PROMOTION_DEFAULT_ROW,
  getPromotionFields,
} from './employee-promotion-fields';

export default function EmployeePromotionTab() {
      ...
      {(listFields, { add, remove }) => (
        <div className="employee-entry-list-tab">
          ...
          {listFields.map((field, index) => (
            <div key={field.key} className="employee-entry-list-row">
              ...
              <DynamicForm
                ...
                fields={getPromotionFields(field.name, { employeeOptions, allRows })}
              />
            </div>
          ))}
          ...
          <Button
            ...
            icon={<PlusOutlined />}
            onClick={() => add(PROMOTION_DEFAULT_ROW)}
          >
