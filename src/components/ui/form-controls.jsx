const inputClass =
  'w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 outline-none transition placeholder:text-[#6C6C6C] placeholder:font-medium placeholder:text-xs placeholder:leading-none placeholder:tracking-[0.04em] focus:border-[var(--app-primary)] focus:ring-2 focus:ring-[var(--app-primary)]/15';
