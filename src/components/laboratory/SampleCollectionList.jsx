...
import SampleCollectionFormView from '@/components/laboratory/SampleCollectionFormView';
...
export default function SampleCollectionList() {
      ...
      { title: 'Lab #', dataIndex: 'labNo', key: 'labNo', width: 90 },
      {
        ...
        render: (_, record) => (
          <Button
            ...
            onClick={() => openCollectionForm(record)}
          >
            Collect Sample
          </Button>
        ),
  ...
  if (activeRecord) {
    return <SampleCollectionFormView record={activeRecord} />;
  }
