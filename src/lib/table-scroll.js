/** Shared vertical scroll height for walk-in table bodies (tbody only). */
export const WALK_IN_TABLE_BODY_SCROLL_Y = 200;

export const WALK_IN_SERVICES_SIDEBAR_SCROLL_Y = 160;
